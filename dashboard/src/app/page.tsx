...
export default function CsoDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<
    "dashboard" | "documents" | "briefing" | "config"
  >("dashboard");
  ...
  const extractCitations = (text: string) => {
    ...
    while ((match = regex.exec(text)) !== null) {
      ...
      if (
        !citations.some(
          (c) => c.docName === docName && c.chunkIndex === chunkIndex,
        )
      ) {
                  ...
                  <div className="scheduler-panel">
                    {!schedulerConfirmed && !schedulerDeclined ? (
                      <div className="animate-fade-in">
                        ...
                        <p>
                          Your Scheduler Agent has proposed a meeting with John
                          Doe. Please review details.
                        </p>
          ...
          <div className="dashboard-tab-view">
            ...
            <header className="dashboard-header">
              <div className="header-left">
                ...
                <p>
                  3 agents active •{" "}
                  {schedulerConfirmed || schedulerDeclined ? "0" : "1"} pending
                  action
                </p>
              </div>
                ...
                <div className="ready-view">
                  ...
                  <div className="pills-grid">
                    {[
                      ...
                      {
                        text: "Any new regulatory updates?",
                        label: "Regulatory updates",
                        icon: Globe,
                      },
                      {
                        text: "How do we compare against competitors?",
        ...
        {activeTab === "documents" && (
          <div className="documents-tab-view">
            <header>
              ...
              <p>
                Grounding corpus for RAG semantic search and policy analysis
              </p>
            </header>
              ...
              {isUploading ? (
                <div className="upload-progress">
                  ...
                  <p className="muted-text">
                    Generating embeddings through OpenRouter
                  </p>
                </div>
              ) : uploadSuccess ? (
                <div className="upload-success">
                  ...
                  <p className="success-desc">
                    Indexed for real-time strategic citation.
                  </p>
                </div>
              ) : (
                <div className="upload-prompt-info">
                  ...
                  <p className="bold-text">
                    Drag & drop your strategic PDFs here
                  </p>
                  <p className="muted-text">
                    Accepts PDF, DOCX, TXT, Markdown (Max 15MB)
                  </p>
          ...
          <div className="briefing-tab-view">
            <header className="briefing-header">
              <div>
                ...
                <p>
                  Aggregated regulatory changes, market flows, and competitor
                  SWOT indices
                </p>
              </div>
              <button
                    ...
                    <div className="alerts-list-stack">
                      {briefing.critical.length > 0 ? (
                        briefing.critical.map((item, idx) => (
                          <div
                            key={idx}
                            className="briefing-alert-card critical"
                          >
                            <h4>{item.title}</h4>
                            <p>{item.summary}</p>
                    ...
                    <div className="alerts-list-stack">
                      {briefing.monitoring.length > 0 ? (
                        briefing.monitoring.map((item, idx) => (
                          <div
                            key={idx}
                            className="briefing-alert-card monitoring"
                          >
                            <h4>{item.title}</h4>
                            <p>{item.summary}</p>
                            <span className="source">
                    ...
                    <div className="alerts-list-stack">
                      {briefing.opportunities.length > 0 ? (
                        briefing.opportunities.map((item, idx) => (
                          <div
                            key={idx}
                            className="briefing-alert-card opportunity"
                          >
                            <h4>{item.title}</h4>
                            <p>{item.summary}</p>
                            <span className="source">
        ...
        {activeTab === "config" && (
          <div className="config-tab-view">
            <header>
              ...
              <p>
                Review system prompts and RACER framework configurations for
                sub-agents
              </p>
            </header>
            ...
            <div className="config-scroll">
              {Object.keys(systemPrompts).length > 0 ? (
                Object.entries(systemPrompts).map(
                  ([agentName, promptContent]) => (
